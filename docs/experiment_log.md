...
| 027 | 2026-06-22 | `s027-roman-v10-strong-start-baseline.tar.gz` | 600.0 | complete | Tested the public Roman V10 Strong Start baseline after the 2026-06-22 code refresh. Initial public score was weak, so it should not be used as a final guard unless it later refreshes upward. |

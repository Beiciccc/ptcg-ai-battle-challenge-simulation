...
| 035 | 2026-06-23 | `s010-resubmit-crustle-specific.tar.gz` | 675.2 | complete | Re-submitted the Crustle-specific guard package as the first final latest-two slot. Refreshed public score recovered but stayed below the Naoto reroll. |

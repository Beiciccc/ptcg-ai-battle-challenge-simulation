...
| 022 | 2026-06-21 | `s009-resubmit-lucario-full.tar.gz` | 526.0 | complete | Re-submitted the historical full Lucario guard package as the first 2026-06-21 repair slot. Refreshed public score was weak, so it should not be used as a final guard without later recovery. |

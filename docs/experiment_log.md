...
| 025 | 2026-06-21 | `s011-final-strongstart-retuned.tar.gz` | 600.0 | complete | Re-submitted the retuned Strong Start guard package as the first final latest-two slot. Initial public score was weak, so the last slot remains the historical full Lucario guard. |
| 026 | 2026-06-21 | `s009-resubmit-lucario-full.tar.gz` | 600.0 | complete | Re-submitted the historical full Lucario guard package as the final latest-two slot. Initial public score was weak; the strongest 2026-06-21 refresh in this batch was experiment 023. |

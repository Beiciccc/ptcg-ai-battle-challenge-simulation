...
| 023 | 2026-06-21 | `s010-resubmit-crustle-specific.tar.gz` | 718.4 | complete | Re-submitted the historical Crustle-specific guard package as a diversity repair slot. Refreshed public score recovered from the initial result but stayed below earlier runs. |
| 024 | 2026-06-21 | `s024-alakazam-psychic-control.tar.gz` | 600.0 | complete | Tested a public Alakazam psychic-control candidate after the latest public meta scan. Initial public score was weak, so the final two slots revert to historical guard packages. |

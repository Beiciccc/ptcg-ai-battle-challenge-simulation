...
| 032 | 2026-06-23 | `s028-naoto-hop-alakazam-target.tar.gz` | 737.9 | complete | Re-submitted the Naoto Hop/Alakazam target-priority Lucario variant after it was the strongest refreshed 2026-06-22 result. Refreshed public score recovered but stayed below the previous day's best run. |
| 033 | 2026-06-23 | `s013-lucario-search-915.tar.gz` | 600.0 | complete | Re-submitted the Lucario search 915 package as a high-ceiling guard reroll. Initial public score was weak, so the next slot tests the Strong Start guard before final selection. |

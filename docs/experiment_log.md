...
| 032 | 2026-06-23 | `s028-naoto-hop-alakazam-target.tar.gz` | 600.0 | complete | Re-submitted the Naoto Hop/Alakazam target-priority Lucario variant after it was the strongest refreshed 2026-06-22 result. Initial public score was weak, so it is not kept as an automatic final guard. |

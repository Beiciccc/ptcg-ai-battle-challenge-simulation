...
| 029 | 2026-06-22 | `s013-lucario-search-915.tar.gz` | 703.9 | complete | Re-submitted the Lucario search 915 package as a high-ceiling reroll. Refreshed public score recovered from the initial result but stayed below the Naoto target variant. |
| 030 | 2026-06-22 | `s010-resubmit-crustle-specific.tar.gz` | 600.0 | complete | Re-submitted the Crustle-specific guard package as the first final latest-two slot. Initial public score was weak, so the final slot repeats the same guard for refresh variance. |
| 031 | 2026-06-22 | `s010-resubmit-crustle-specific.tar.gz` | 600.0 | complete | Re-submitted the Crustle-specific guard package as the final latest-two slot. Initial public score was weak; the best 2026-06-22 result in this batch was experiment 028. |
...
| 034 | 2026-06-23 | `s011-final-strongstart-retuned.tar.gz` | 600.0 | complete | Re-submitted the retuned Strong Start guard as an upside probe. Initial public score was weak, so the final two slots prioritize Crustle-specific and the best current reroll. |
| 035 | 2026-06-23 | `s010-resubmit-crustle-specific.tar.gz` | 600.0 | complete | Re-submitted the Crustle-specific guard package as the first final latest-two slot. Initial public score was weak, so the final slot returns to the best current Naoto reroll. |
| 036 | 2026-06-23 | `s028-naoto-hop-alakazam-target.tar.gz` | 600.0 | complete | Re-submitted the Naoto Hop/Alakazam target-priority Lucario variant as the final latest-two slot. Initial public score was weak; the strongest 2026-06-23 refresh in this batch was experiment 032. |

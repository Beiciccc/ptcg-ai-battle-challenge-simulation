...
| 028 | 2026-06-22 | `s028-naoto-hop-alakazam-target.tar.gz` | 690.5 | complete | Tested the public Naoto Hop/Alakazam target-priority Lucario variant after the 2026-06-22 code refresh. Refreshed public score improved from the initial result but stayed below prior guards. |
| 029 | 2026-06-22 | `s013-lucario-search-915.tar.gz` | 600.0 | complete | Re-submitted the Lucario search 915 package as a high-ceiling reroll. Initial public score was weak, so the final two slots prioritize the stronger Crustle-specific guard. |

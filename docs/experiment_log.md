...
| 027 | 2026-06-22 | `s027-roman-v10-strong-start-baseline.tar.gz` | 731.5 | complete | Tested the public Roman V10 Strong Start baseline after the 2026-06-22 code refresh. Refreshed public score recovered from the initial result but stayed below the strongest guard candidates. |
| 028 | 2026-06-22 | `s028-naoto-hop-alakazam-target.tar.gz` | 600.0 | complete | Tested the public Naoto Hop/Alakazam target-priority Lucario variant after the 2026-06-22 code refresh. Initial public score was weak, so the next slots return to historical high performers. |

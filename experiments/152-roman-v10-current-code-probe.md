...
- Public evaluation moved from the 600.0 baseline through 498.5 and 447.0 before
  recovering to 529.5; the source notebook title is not treated as independently
  verified leaderboard evidence.

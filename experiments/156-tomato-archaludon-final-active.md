# 156 Tomato Archaludon Final Active

Date: 2026-07-21 UTC

Local generated package (not committed): `artifacts/submissions/s156-tomato-archaludon-final-active.tar.gz`
...
Summary:
- Re-submitted the exact experiment 151 archive as the second final active
  strategy for the current submission window.
- Selected Tomato Archaludon to retain a distinct, low-runtime strategy family
  beside the preceding Search-Augmented Alakazam submission.
- Preserved every archive byte, so the new observation changes only the public
  evaluation window.

Validation:
- Archive bytes match experiments 151 and 154 exactly
- Clean 11-file archive with `main.py`, `deck.csv`, and nine runtime files
- No links, cache files, AppleDouble files, unsafe paths, or nested archive root
- Final top-level function: `agent`
- 60-card deck check
- Three new-seed archive-root smoke battles completed in 142, 127, and 164 steps

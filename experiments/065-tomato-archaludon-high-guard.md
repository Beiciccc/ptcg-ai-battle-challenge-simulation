...
- This rerun refreshed into the strongest result in the batch, and the same
  package still owns the strongest latest results in this lane.
...
- Latest refreshed public score was 948.4.
